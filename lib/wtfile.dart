...
class _weatherState extends State<weather> {
  ...
  double latitude =23.0333;
  double longitude =72.6167;
  ...
  Future<List<forecast>> getweather() async
  {
   // Position p=await _determinePosition();
    Response r=await get(Uri.parse("https://api.openweathermap.org/data/2.5/onecall?lat=${latitude}&lon=${longitude}&exclude=hourly,minutely&appid=b72a4577eb5888801e94b7bf4afbf2dc"));
    //print(r.body);
